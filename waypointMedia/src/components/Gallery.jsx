    ...
    return (
        <>
           <div className="relative group ">
                ...
                <div className="flex opacity-0 items-center justify-between border border-white bg-white py-2 text-xl font-Cal_Sans absolute bottom-5 w-11/12 h-20 rounded-xl px-5 mx-auto right-6 group-hover:opacity-100 transition-all duration-1000 ease-in-out">
                    <div>
                        {name}
                    </div>
                    <div>
    ...
    return (
        <>
            <div className="flex flex-col gap-10 py-40">
                ...
                <div className="grid grid-cols-2 mx-auto justify-center items-center w-10/12 gap-3">
