...
function SocialIcons({name,path,socialLink}){
    return (
        <>
            <li>
                <a aria-label={`Follow us on ${name}`} href={socialLink} target="_blank" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                    <svg aria-hidden="true" className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                       {path}
                    </svg>
                </a>
            </li>
...
export function Footer({content}){
    ...
    const linkInfo = [
        {id:0,name:'X',link:'https://www.x.com',svgPath:pathX},
        {id:1,name:'Facebook',link:'https://www.facebook.com',svgPath:pathFacebook},
        {id:2,name:'Instagram',link:'https://www.instagram.com/bluepeak_777/',svgPath:pathInsta},
    ]
                    ...
                    <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                        <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                            ...
                            <ul className="flex items-center space-x-3 mt-9">
                                {linkInfo.map(link=>{
                                    return <SocialIcons name={link.name} path={link.svgPath} socialLink={link.link}/>
                                })}
                            </ul>
                        </div>
